...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --animation-sentence: 'Vous savez que vous n\'êtes pas censé traîner ici ?';
 ...
 */
        ...
        @keyframes showText {
            ...
            100% {
                --animation-sentence: 'Tellement à faire, si peu de temps pour le faire...';
            }
        }
        ...
        @keyframes showNewText {
            ...
            100% {
                --animation-sentence: 'OK, apparemment vous n\'en avez rien à faire. Voilà une clef pour vous.';
            }
        }
...
-->
    ...
    <script>
        ...
        const grantAccess = () => {
            ...
            heading.textContent = '🎉 Youhou 🎉';
            paragraph.textContent = 'Accès autorisé';
