...
class Ane extends Monture {
    ...
    public function trotte() {
        if ($this->endurance > 0) {
            ...
            echo 'L\'âne avance à une vitesse de ' . $vitesse_reelle . ' km/h.';
            $this->endurance -= 5;
        } else {
            echo 'L\'âne a atteint ses limites et refuse d\'avancer plus.';
        }
    }

    public function neBougePas() {
        echo 'L\'âne fait sa tête de mule et refuse de se déplacer.';
    }
